...
class UserComparatorByRollNoAscTest {
  private static Stream<CompareToTestCaseStructure> generateTestForCompare(){
    ...
    User secondUser1 = new User("User 2",18,"address 2","Roll No 2", Arrays.asList("A","B","F","D"));
    ...
    User firstUser2 = new User("User 1",10,"address 2","Roll No 2", Arrays.asList("A","B","C","D"));
    User secondUser2 = new User("User 2",18,"address 1","Roll No 1", Arrays.asList("A","B","F","D"));
    ...
    User secondUser3 = new User("User 2",18,"address 2","Roll No 1", Arrays.asList("A","B","F","D"));
  ...
  void compare(CompareToTestCaseStructure testCase) {
    UserComparatorByRollNoAsc comparator = new UserComparatorByRollNoAsc();
