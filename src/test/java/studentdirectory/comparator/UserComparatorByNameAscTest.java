...
class UserComparatorByNameAscTest {
  private static Stream<CompareToTestCaseStructure> generateTestForCompare(){
    ...
    User firstUser2 = new User("User 2",10,"address 2","Roll No 1", Arrays.asList("A","B","C","D"));
    ...
    User secondUser3 = new User("User 1",18,"address 2","Roll No 3", Arrays.asList("A","B","F","D"));
