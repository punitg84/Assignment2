...
class UserValidatorTest {
  private static Stream<ValidateUserTestScenario> generateTestCaseForValidateUser() {
    ...
    ValidateUserTestScenario
        testCase1 = new ValidateUserTestScenario();
    ...
    ValidateUserTestScenario
        testCase2 = new ValidateUserTestScenario();
    ...
    User user3 = new User("Punit", 10, "address 1", "rollNo 1",
        Arrays.asList(Courses.A,Courses.B,Courses.C,Courses.D));
    ValidateUserTestScenario
        testCase3 = new ValidateUserTestScenario();
  ...
  private static Stream<ValidateAgeNumericTestScenario> generateTestCaseForValidateAgeNumeric() {
    ...
    ValidateAgeNumericTestScenario
        testCase1 = new ValidateAgeNumericTestScenario();
    ...
    ValidateAgeNumericTestScenario
        testCase2 = new ValidateAgeNumericTestScenario();
    testCase2.setAge("5");
  ...
  private static Stream<ValidateCoursesTestScenario> generateTestCaseForValidateCourses() {
    ...
    ValidateCoursesTestScenario
        testCase1 = new ValidateCoursesTestScenario();
    ...
    ValidateCoursesTestScenario
        testCase2 = new ValidateCoursesTestScenario();
    ...
    ValidateCoursesTestScenario
        testCase3 = new ValidateCoursesTestScenario();
